...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <h3>Consigue tu entrada</h3>
                    <h1>Escápate a tu evento favorito</h1>
                    <h5>Encuentra el evento que buscas en nuestro portfolio.</h5>
                    <h5>También puedes usar el buscador.</h5>
                </div>
                    ...
                    <div class="he-wrap tpl6">
                        ...
                        <div class="he-view">
                            <div class="bg a0" data-animate="fadeIn">
                                ...
                                <a href="single-project" class="dmbutton a2" data-animate="fadeInUp"><i class="fa fa-link"></i></a>
                            </div>
                            <!-- he bg -->
                        </div>
                        <!-- he view -->
    ...
    <div class="container mtb">
        <div class="row">
            ...
            <div class="col-lg-3">
                <h4>Latest Posts</h4>
                <div class="hline"></div>
                <p><a href="single-post">Our new site is live now.</a></p>
                <p><a href="single-post">Retina ready is not an option.</a></p>
                <p><a href="single-post">Bootstrap 3 framework is the best.</a></p>
                <p><a href="single-post">You need this theme, buy it now.</a></p>
                <p><a href="single-post">This theme is what you need.</a></p>
            </div>
        ...
        <div class="container">
            <div class="row centered partners">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <img src="img/partners/partner01.png" class="img-responsive">
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <img src="img/partners/partner02.png" class="img-responsive">
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <img src="img/partners/partner03.png" class="img-responsive">
                </div>
            </div>
            <!-- /row -->
        </div>
    ...
    <div class="fixed-ad">
        <div class="he-wrap tpl6">
            ...
            <div class="he-view">
                <div class="bg a0" data-animate="fadeIn">
                    <h3 class="a1" data-animate="fadeInDown">Tú también puedes ayudar</h3>
                    <a data-rel="prettyPhoto" href="img/portfolio/portfolio_02.jpg" class="dmbutton a2" data-animate="fadeInUp"><i class="fa fa-search"></i></a>
                    <a href="single-project" class="dmbutton a2" data-animate="fadeInUp"><i class="fa fa-link"></i></a>
                </div>
                <!-- he bg -->
