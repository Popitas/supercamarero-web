...
class PageController extends Controller
{
    ...
    public function store(PageFormRequest $request)
    {
        ...
        alert()->success('El plato ha sido añadido con éxito.');
    ...
    public function update(PageFormRequest $request, Page $page)
    {
        ...
        alert()->success('El plato ha sido actualizado con éxito.');
    ...
    public function destroy($id)
    {
        ...
        alert()->success('El plato ha sido eliminado con éxito.');
